...
public class ShitingBean {
    ...
    public ShitingBean(List<V9LG4B3A0Entity> v9LG4B3A0) {
        V9LG4B3A0 = v9LG4B3A0;
    }


    public void setV9LG4B3A0(List<V9LG4B3A0Entity> v9LG4B3A0) {
        V9LG4B3A0 = v9LG4B3A0;
    }

    public List<V9LG4B3A0Entity> getV9LG4B3A0() {
        return V9LG4B3A0;
    }

    public static class V9LG4B3A0Entity {
